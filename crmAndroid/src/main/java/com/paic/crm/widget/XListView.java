		...
		default:
			...
			if (getFirstVisiblePosition() == 0) {
				...
				if (mEnablePullRefresh
						&& mHeaderView.getVisiableHeight() > mHeaderViewHeight&&mPullRefreshing==false) {
			...
			if (getLastVisiblePosition() == mTotalItemCount - 1) {
				// 调用加载更多.
				if (mEnablePullLoad
						&& mFooterView.getBottomMargin() > PULL_LOAD_MORE_DELTA&&mPullLoading==false) {
...
//	private GridView gridViewPlus,gridViewFace;
//	private IMActivity imActivity;
//	
//	public void setImActivity(IMActivity imActivity) {
//		this.imActivity = imActivity;
//		// TODO 初始化gridView
//		gridViewFace = imActivity.getGridViewFace();
//		gridViewPlus = imActivity.getGridViewPlus();
//	}
	...
	public void onScroll(AbsListView view, int firstVisibleItem,
		...
		// 发送到用户的监听器
//		Log.i("bottom", "bottom=onScroll--"+imActivity+"--"+gridViewFace+"--"+gridViewPlus);
...
//		Log.i("bottom", "bottom=onSizeChanged="+w+"---"+h+"---"+oldw+"--"+oldh);
//		Log.i("bottom", "bottom=onSizeChanged="+(h-oldh));
//		if(imActivity!=null&&null!=gridViewFace&&null!=gridViewPlus){
//			keyState=imActivity.getKeyState();
//			Log.i("bottom", "bottom=keyState="+keyState);
//			if(keyState==true&&(oldh-h)>0){
//				imActivity.hideGridView();
//			}
//		}
