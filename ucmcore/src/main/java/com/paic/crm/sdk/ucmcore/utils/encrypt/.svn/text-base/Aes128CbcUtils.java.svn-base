...
public class Aes128CbcUtils {
	...
	public static String encrypt(String content, String key) {
		try {
			...
			String base64Str = Base64.encodeToString(enc, Base64.DEFAULT);
			return new String(base64Str.getBytes(), CHARSET_NAME);
		}
		catch (UnsupportedEncodingException e) {
			CRMLog.LogError(" 解密密钥异常 ", e.getMessage());
		}
	...
	public static void main(String[] args) throws Exception {
		...
		long timestamp = new Date().getTime() + 1000*60*3;
		...
		String content = "timestamp="+timestamp+"&nonce="+nonce+"&signature="+signature+"&umId=CUIJUN629";//&customerId=170B3FA426736D29E0530F0A1F0AA100";
		// 加密字符串
		System.out.println("加密前的：" + content);
