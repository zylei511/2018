...
public class LoginDesUtil {
    ...
    public static String encryptToURL(String value, String key) {
        return encryptToURL(value, key, false);
    }
     ...
     * @return 3DES���ܺ���Base64������ַ�
     */
    public static String encryptToURL(String value, String key, boolean isEncrypt) {
        if (isEncrypt) {
    ...
    public static String decryptToURL(String value, String key) {
        return decryptToURL(value,key,false);
    }
     ...
     * @return ����ԭ��
     */
    public static String decryptToURL(String value, String key, boolean isDecrypt) {
        if (isDecrypt) {
